            ...
            <div class="row-fluid">
                <div class="span12">
                        ...
                        @if (count($users) > 0)
                            @foreach ($users as $user)
								...
								{!! Form::open(['method' => 'POST']) !!}
                                    ...
                                    <td style="width: 70%;"><input type="text" name="message" class="form-control" required style="width: 100%;"></td>
					...
					<div class="form-group">
						<textarea class="form-control" rows="3" name="message_all" required style="width: 100%;"></textarea>
					</div>
