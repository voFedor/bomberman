        ...
        <div class="container">
            ...
            <div class="row-fluid">
                <div class="span5">
					...
					<iframe src="https://money.yandex.ru/quickpay/shop-widget?writer=seller&targets=%D0%9F%D0%BE%D0%BF%D0%BE%D0%BB%D0%BD%D0%B5%D0%BD%D0%B8%D0%B5%20%D0%B1%D0%B0%D0%BB%D0%B0%D0%BD%D1%81%D0%B0&targets-hint=&default-sum=1000&button-text=11&payment-type-choice=on&label={{Auth::user()&mobile-payment-type-choice=on&hint=&successURL={{env('YANDEX_SUCCESS_URL')}}&quickpay=shop&account={{env('YANDEX_SHOP_ID')}}" width="93%" height="223" frameborder="0" allowtransparency="true" scrolling="no"></iframe>
