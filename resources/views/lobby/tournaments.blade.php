...
@section('content')
    ...
    <div class="section secondary-section">
        ...
        <div class="container">
            ...
            <script src="http://megatimer.ru/s/3612c52908168017d6b32e29860f627f.js"></script>
        </div>
    </div>
        ...
        <div class="container centered">
            <div class="sub-section">
                ...
                <ul class="row client-slider" id="clint-slider">
                    @foreach($bets as $bet)
                        <li>
                            <a href="javascript:void(0)" onclick="return checkBet('{{ $bet->openUrl() }}', '{{ $bet->game->name }} {{ $bet->bet }}', {{$bet->bet}}, {{Auth::user()->credits}}, {{$bet->game->id}})">
