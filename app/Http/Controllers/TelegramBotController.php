...
class TelegramBotController extends Controller
{
	...
	protected function answerCallbackQuery($update)
    {
		...
		if(isset($session['message'])){
			...
			$data['url'] = 'https://'.env('TELEGRAM_NGROK').'.ngrok.io/math/index.html?user_id='.$user_id.'&inline_message_id='.$inline_message_id.'&chat_id='.$chat_id.'&message_id='.$message_id.'&message_id='.$message_id;
		}
